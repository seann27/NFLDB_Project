...
class GameSummary:
	...
	def get_summary(self):
		gamelinks = PFR_Gamelinks(self.season,self.week).get_game_links()
		...
		gameinfo_gameids = pd.read_sql_query(sql, conn, params=(self.season,self.week), index_col=None)
		...
		home_sacked_mets = pd.read_sql_query(home_sacked_sql, conn, index_col=None)
		home_sacked_mets.set_index('game_id',inplace=True)
		home_short_pass_int_mets = pd.read_sql_query(home_short_pass_int_sql, conn, index_col=None)
		home_short_pass_int_mets.set_index('game_id',inplace=True)
		home_deep_pass_int_mets = pd.read_sql_query(home_deep_pass_int_sql, conn, index_col=None)
		...
		away_sacked_mets = pd.read_sql_query(away_sacked_sql, conn, index_col=None)
		away_sacked_mets.set_index('game_id',inplace=True)
		away_short_pass_int_mets = pd.read_sql_query(away_short_pass_int_sql, conn, index_col=None)
		away_short_pass_int_mets.set_index('game_id',inplace=True)
		away_deep_pass_int_mets = pd.read_sql_query(away_deep_pass_int_sql, conn, index_col=None)
