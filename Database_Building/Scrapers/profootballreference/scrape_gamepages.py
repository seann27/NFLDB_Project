...
for season in seasons:
	for week in weeks:
		...
		for game in games:
			...
			logging.debug(str(season)+" | "+str(week)+" | "+gameid+" | "+team_home+" | "+str(points_home)+" | "+team_away+" | "+str(points_away)+" | "+str(vegasline)+" | "+str(overunder))
			...
			sql_val = (
				gameid,season,week,team_home,points_home,team_away,points_away,0,overunder,
				team_home,points_home,team_away,points_away,0,overunder
			)
			try:
